...
[[images/Element-Type-Specs-textInfo-none.png|style:none]]

### `style: basic`

[[images/Element-Type-Specs-textInfo-basic.png|style:basic]]

### `style: info`

[[images/Element-Type-Specs-textInfo-info.png|style:info]]

### `style: warning`

[[images/Element-Type-Specs-textInfo-warning.png|style:warning]]

### `style: success`

[[images/Element-Type-Specs-textInfo-success.png|style:success]]

### `style: positive`

[[images/Element-Type-Specs-textInfo-positive.png|style:positive]]

### `style: error`

[[images/Element-Type-Specs-textInfo-error.png|style:error]]

### `style: negative`

[[images/Element-Type-Specs-textInfo-negative.png|style:negative]]
...
- **displayType** `string` (must be either `table` or `cards` (default)) -- how to present the list of items, as shown here:
  ...
  - **table** view:
    ...
    [[images/Element-Type-Specs-listBuilder-table-view.png|Table View]]

    For table view, the column headers are taken from the **title** fields of each element

  - **card** view:

    [[images/Element-Type-Specs-listBuilder-card-view.png|Card View]]
...
[[images/Element-Type-Specs-search-results.png|Search Results]]

Once selected, items are displayed in a "card" view:

[[images/Element-Type-Specs-search-selected.png|Search Selected]]
...
[[images/Element-Type-Specs-date-picker.png|Date picker]]
